...
export const OldNavbar = () => {
  ...
  return (
    <SectionContainer sx={{ height: 46, justifyContent: 'space-between' }}>
      <nav className="nav-redoutable clearfix hovered" style={{ width: '100%', margin: 0 }}>
        <ul className="inner-nav-redoutable reset-list">
          <li
            id="navItem_35682"
            className="nav-item-redoutable single multiline"
            style={{ borderColor: '#BE003C' }}>
            <div className="tab">
          ...
          <li
            id="navItem_35693"
            className="nav-item-redoutable single"
            style={{ borderColor: '#BE003C' }}>
            <div className="tab">
