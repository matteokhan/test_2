    ...
    <nav className="nav-redoutable clearfix hovered" style={{ width: '100%', margin: 0 }}>
      <ul className="inner-nav-redoutable reset-list">
        <li
          ...
          style={{ borderBottomColor: '#BE003C' }}
                ...
                <div className="sub-panel clearfix" style={{ backgroundColor: '#FFF' }}>
                  <div id="Menu_destinations_Europe_Iles">
                    <div
                      ...
                      <br /> <a href="https://www.leclercvoyages.com/search?m_c.desti=CY">Chypre</a>
                      <br />{' '}
                      <a href="https://www.leclercvoyages.com/search?m_c.desti=FR.COR">Corse</a>
                      <br /> <a href="https://www.leclercvoyages.com/search?m_c.desti=HER">Crète</a>
                      <br />{' '}
                      <a href="https://www.leclercvoyages.com/search?m_c.desti=GR2">
                        Iles Grecques
                      </a>
                      <br /> <a href="https://www.leclercvoyages.com/search?m_c.desti=P1">Madère</a>
                      <br />{' '}
                      <a href="https://www.leclercvoyages.com/search?m_c.desti=SARD">Sardaigne</a>
                      <br />{' '}
                  ...
                  <div id="Menu_Destinations_Europe_Sud">
                    <div
                      ...
                      <br /> <a href="https://www.leclercvoyages.com/search?m_c.desti=GR">Grèce</a>
                      <br /> <a href="https://www.leclercvoyages.com/search?m_c.desti=IT">Italie</a>
                      <br />{' '}
                      <a href="https://www.leclercvoyages.com/search?m_c.desti=MK">Macédoine</a>
                      <br /> <a href="https://www.leclercvoyages.com/search?m_c.desti=MT">Malte</a>
                      <br /> <a href="https://www.leclercvoyages.com/search?m_c.desti=MC">Monaco</a>
                      <br />{' '}
                      <a href="https://www.leclercvoyages.com/search?m_c.desti=ME">Monténégro</a>
                      <br />{' '}
                      <a href="https://www.leclercvoyages.com/search?m_c.desti=PT">Portugal</a>
                      <br /> <a href="https://www.leclercvoyages.com/search?m_c.desti=RS">Serbie</a>
                      <br /> <a href="https://www.leclercvoyages.com/search?m_c.desti=CH">Suisse</a>
                    </div>
                  </div>
                  <div id="Menu_Destinations_Europe_Nord">
                    <div
                      ...
                      <br />{' '}
                      <a href="https://www.leclercvoyages.com/search?m_c.desti=UK">Royaume Uni</a>
                      <br /> <a href="https://www.leclercvoyages.com/search?m_c.desti=SE">Suède</a>
                    </div>
                  </div>
                  <div id="Menu_Destinations_Europe_Est">
                    <div
                      ...
                      <br />
                      <a href="https://www.leclercvoyages.com/search?m_c.desti=BY">Biélorussie</a>
                      <br />
                      ...
                      <br />
                      <a href="https://www.leclercvoyages.com/search?m_c.desti=SICL">Slovénie</a>
                    </div>
                  </div>
                </div>
              </li>
                ...
                <div className="sub-panel clearfix" style={{ backgroundColor: '#FFF' }}>
                  <div id="Menu_Destinations_Orient_Mediterranee">
                    <div
                      ...
                      <br /> <a href="https://www.leclercvoyages.com/search?m_c.desti=EG">Egypte</a>
                      <br /> <a href="https://www.leclercvoyages.com/search?m_c.desti=MA">Maroc</a>
                      <br />{' '}
                  ...
                  <div id="Menu_Destinations_Orient_Arabe">
                    <div
                      ...
                      <a href="https://www.leclercvoyages.com/search?m_c.desti=AE.AUH">Abu Dhabi</a>
                      <br />{' '}
                      ...
                      <br /> <a href="https://www.leclercvoyages.com/search?m_c.desti=OM">Oman</a>
                      <br />{' '}
                ...
                <div className="sub-panel clearfix" style={{ backgroundColor: '#FFF' }}>
                  <div id="Menu_Destinations_Antilles_Grandes">
                    <div
                      ...
                      <br /> <a href="https://www.leclercvoyages.com/search?m_c.desti=HT">Haïti</a>
                      <br />{' '}
                      <a href="https://www.leclercvoyages.com/search?m_c.desti=JM">Jamaïque</a>
                      <br />{' '}
                      <a href="https://www.leclercvoyages.com/search?m_c.desti=PR">Porto Rico</a>
                      <br />{' '}
                  ...
                  <div id="Menu_Destinations_Antilles_Petites">
                    <div
                      ...
                      <br /> <a href="https://www.leclercvoyages.com/search?m_c.desti=BZ">Belize</a>
                      <br />{' '}
                      ...
                      <br />{' '}
                      <a href="https://www.leclercvoyages.com/search?m_c.desti=KY">Iles Caïmans</a>
                      <br />{' '}
                  ...
                  <div id="Menu_Destinations_Antilles_Francophones">
                    <div
                      ...
                      <br />{' '}
                      <a href="https://www.leclercvoyages.com/search?m_c.desti=GP">Guadeloupe</a>
                      <br /> <a href="https://www.leclercvoyages.com/search?m_c.desti=HT">Haïti</a>
                      <br />{' '}
                      <a href="https://www.leclercvoyages.com/search?m_c.desti=MQ">Martinique</a>
                      <br />{' '}
                      <a href="https://www.leclercvoyages.com/search?m_c.desti=BL">
                        Saint Barthélémy
                      </a>
                      <br />{' '}
                      <a href="https://www.leclercvoyages.com/search?m_c.desti=LC">Sainte Lucie</a>
                      <br />{' '}
                      <a href="https://www.leclercvoyages.com/search?m_c.desti=MF">Saint Martin</a>
                    </div>
                  </div>
                </div>
              </li>
                ...
                <div className="sub-panel clearfix" style={{ backgroundColor: '#FFF' }}>
                  <div id="Menu_Destinations_Amerique_Nord">
                    <div
                      ...
                      <br />{' '}
                      <a href="https://www.leclercvoyages.com/search?m_c.desti=US">Etats-Unis</a>
                      <br />{' '}
                  ...
                  <div id="Menu_Destinations_Amerique_Centrale">
                    <div
                      ...
                      <br />{' '}
                      <a href="https://www.leclercvoyages.com/search?m_c.desti=CR">Costa Rica</a>
                      <br />{' '}
                      ...
                      <br /> <a href="https://www.leclercvoyages.com/search?m_c.desti=PA">Panama</a>
                      <br />{' '}
                  ...
                  <div id="Menu_Destinations_Amerique_Sud">
                    <div
                      ...
                      <br /> <a href="https://www.leclercvoyages.com/search?m_c.desti=BR">Brésil</a>
                      <br /> <a href="https://www.leclercvoyages.com/search?m_c.desti=CL">Chili</a>
                      <br />{' '}
                      ...
                      <br /> <a href="https://www.leclercvoyages.com/search?m_c.desti=PE">Pérou</a>
                      <br />{' '}
                ...
                <div className="sub-panel clearfix" style={{ backgroundColor: '#FFF' }}>
                  <div id="Menu_Destinations_Asie_Sud">
                    <div
                      ...
                      <br /> <a href="https://www.leclercvoyages.com/search?m_c.desti=IN">Inde</a>
                      <br />{' '}
                      ...
                      <br /> <a href="https://www.leclercvoyages.com/search?m_c.desti=NP">Népal</a>
                      <br />{' '}
                      <a href="https://www.leclercvoyages.com/search?m_c.desti=RE">Réunion</a>
                      <br />{' '}
                      <a href="https://www.leclercvoyages.com/search?m_c.desti=SC">Seychelles</a>
                      <br />{' '}
                  ...
                  <div id="Menu_Destinations_Asie_Sud-Est">
                    <div
                      ...
                      <br /> <a href="https://www.leclercvoyages.com/search?m_c.desti=LA">Laos</a>
                      <br />{' '}
                      ...
                      <br />{' '}
                      <a href="https://www.leclercvoyages.com/search?m_c.desti=PH">Philippines</a>
                      <br />{' '}
                  ...
                  <div id="Menu_Destinations_Asie_Est">
                    <div
                      ...
                      <br />{' '}
                      <a href="https://www.leclercvoyages.com/search?m_c.desti=KR">Corée du Sud</a>
                      <br />{' '}
                      <a href="https://www.leclercvoyages.com/search?m_c.desti=HK">Hong-Kong</a>
                      <br /> <a href="https://www.leclercvoyages.com/search?m_c.desti=JP">Japon</a>
                      <br /> <a href="https://www.leclercvoyages.com/search?m_c.desti=TW">Taiwan</a>
                    </div>
                  </div>
                  <div id="Menu_Destinations_Asie_Centrale">
                    <div
                      ...
                      <a href="https://www.leclercvoyages.com/search?m_c.desti=AZ">Azerbaïdjan</a>
                      <br />{' '}
                      <a href="https://www.leclercvoyages.com/search?m_c.desti=MN">Mongolie</a>
                      <br />{' '}
                      <a href="https://www.leclercvoyages.com/search?m_c.desti=UZ">Ouzbékistan</a>
                    </div>
                  </div>
                </div>
              </li>
                ...
                <div className="sub-panel clearfix" style={{ backgroundColor: '#FFF' }}>
                  <div id="Menu_Destinations_Afrique_Australe">
                    <div
                      ...
                      <br />{' '}
                      <a href="https://www.leclercvoyages.com/search?m_c.desti=MZ">Mozambique</a>
                      <br />{' '}
                  ...
                  <div id="Menu_Destinations_Afrique_Equatoriale">
                    <div
                      ...
                      <br /> <a href="https://www.leclercvoyages.com/search?m_c.desti=KE">Kenya</a>
                      <br />{' '}
                      ...
                      <br /> <a href="https://www.leclercvoyages.com/search?m_c.desti=TG">Togo</a>
                    </div>
                  </div>
                  <div id="Menu_Destinations_Afrique_Iles">
                    <div
                      ...
                      <a href="https://www.leclercvoyages.com/search?m_c.desti=MG">Madagascar</a>
                      <br />{' '}
                      <a href="https://www.leclercvoyages.com/search?m_c.desti=MU">Maurice</a>
                      <br />{' '}
                      <a href="https://www.leclercvoyages.com/search?m_c.desti=RE">Réunion</a>
